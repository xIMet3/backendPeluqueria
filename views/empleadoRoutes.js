...
// Ruta para eliminar un usuario y sus citas asociadas por su ID si estás logeado como Empleado.
router.delete("/eliminarUsuario/:id", auth, isEmpleado, empleadoController.eliminarUsuarioConCitas);
